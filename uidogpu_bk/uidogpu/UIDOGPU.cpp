...
#define word_t cl_ulong
    ...
    clret = clEnqueueNDRangeKernel(_command_queue, kernel_gpu_transpose, 1, NULL, &work_size, NULL, 1, &transposeEvent, &transposeGPUEvent);assure(!clret);
...
//        cl_ulong iter = 129;
    ...
    clret = clEnqueueNDRangeKernel(_command_queue, kernel_gpu_transpose_rev, 1, NULL, &work_size, NULL, 1, &appleDerivationEvent, &transposeGPURevEvent);assure(!clret);
